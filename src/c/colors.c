...
void colors_load_default_palettes(VisualizationColors palettes[DISPLAY_MODE_COUNT]) {
        ...
        palettes[DISPLAY_MODE_FUZZY]             = make_palette(bg, GColorMintGreen, GColorWhite, GColorMintGreen);
    #else
        // Monochrome defaults
        const GColor bg = GColorBlack;
        ...
        palettes[DISPLAY_MODE_FUZZY]             = make_palette(bg, primary, primary, primary);
    #endif
}
