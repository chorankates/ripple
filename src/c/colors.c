...
void colors_load_default_palettes(VisualizationColors palettes[DISPLAY_MODE_COUNT]) {
        ...
        palettes[DISPLAY_MODE_FUZZY]           = make_palette(bg, GColorMediumSpringGreen, GColorDarkGray, GColorPastelYellow);
    #else
        // Monochrome defaults
        const GColor bg = GColorBlack;
        ...
        palettes[DISPLAY_MODE_FUZZY]           = make_palette(bg, secondary, secondary, secondary);
    #endif
}
