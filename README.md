...
| Fuzzy | A relative time display | ![aplite](media/screenshots/aplite-fuzzy.png) | ![basalt](media/screenshots/basalt-fuzzy.png) | ![chalk](media/screenshots/chalk-fuzzy.png) | ![diorite](media/screenshots/diorite-fuzzy.png) | ![emery](media/screenshots/emery-fuzzy.png) | 
